  ...
  public void databaseStuff() throws IOException 
  {
    ...
    {   
      ...
      Put p = new Put(Bytes.toBytes("userID"+messageTracker+" Message Number: "+userTracker));
	    ...
	    p.add(Bytes.toBytes("user"), Bytes.toBytes("To:"), Bytes.toBytes("userID"+messageTracker+"@hbase.com"));
        p.add(Bytes.toBytes("user"), Bytes.toBytes("date"), Bytes.toBytes(date));
        p.add(Bytes.toBytes("message"), Bytes.toBytes("messageTitle"), Bytes.toBytes("Message Title:"+ index));
        p.add(Bytes.toBytes("message"), Bytes.toBytes("messageBody"), Bytes.toBytes("This is message:"+ index));
